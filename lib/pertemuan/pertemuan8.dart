        ...
        Autocomplete<String>(
          ...
          fieldViewBuilder: (context, fieldController, focusNode, onFieldSubmitted) {
            return TextFormField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) return 'Silakan pilih $label';
                if (!options.contains(value)) return '$label tidak valid';
                return null;
              },
            );
          },
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: onChanged,
          validator: (value) => value == null ? 'Silakan pilih $label' : null,
